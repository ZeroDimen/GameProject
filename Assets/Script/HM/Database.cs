...
{
    private string path;
    public void DataInput()   //Bullet_Game에 대이터를 인자로 함수 UnityWebRequestGETTest를 호출하여 서버에 데이터를 저장한다.
    {
    ...
    IEnumerator UnityWebRequestGetTest(string[] json)
    {
        ...
        // GET 방식
        string url = $"http://113.198.229.155:4007/update?userID=khm&userPW=gusals&json1='{json[0]}'&json2='{json[1]}'&json3='{json[2]}'";
        Debug.Log(url);
